...
* de variabelen PERIOD moet opgevuld met het verwerkte jaar, de weggeschreven excels krijgen dit jaartal ook mee in de bestandsnaam.
...
* eigenaarswoningen appartementen/huizen.
...
SAVE TRANSLATE OUTFILE='' + locatie_swing + 'kadaster_' + datum_toestand_string + '_extras.xlsx'
  /TYPE=XLS
  /VERSION=12
  /MAP
  /REPLACE
