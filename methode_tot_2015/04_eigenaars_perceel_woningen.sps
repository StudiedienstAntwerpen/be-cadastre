...
AGGREGATE
  /OUTFILE='temp'
  /BREAK=capakey Eig_code type_eigenaar_min
  /N_BREAK=N.
...
* voor de aandelen kunnen we de som nemen.
...
dataset copy woningen.
dataset activate woningen.
match files
/file=*
/keep=art_deelnr woningen.
sort cases art_deelnr (a).

DATASET ACTIVATE eigenaars WINDOW=FRONT.
sort cases art_deelnr (a).
MATCH FILES /FILE=*
  /TABLE='woningen'
  /BY art_deelnr.
EXECUTE.
dataset close woningen.
...
string persoonscode_1 (a45).
string persoonscode_2 (a45).
string persoonscode_3 (a45).
string persoonscode_4 (a45).

if eigenaar_volgnummer=1 persoonscode_1=persoonscode.
if eigenaar_volgnummer=2 persoonscode_2=persoonscode.
if eigenaar_volgnummer=3 persoonscode_3=persoonscode.
if eigenaar_volgnummer=4 persoonscode_4=persoonscode.

* om deze codes mee te kunnen geven aan de aggregatie naar perceeldelen, zorgen we dat alle geldeige waarden tot bij de 4de en laatste eigenaar komen.
sort cases art_deelnr (a) eigenaar_volgnummer (a).
if eigenaar_volgnummer>1 persoonscode_1=lag(persoonscode_1).
if eigenaar_volgnummer>2 persoonscode_2=lag(persoonscode_2).
if eigenaar_volgnummer>3 persoonscode_3=lag(persoonscode_3).
...
AGGREGATE
  ...
  /oud_inwonendantwerps_persoon_wng_eig=SUM(oud_inwonendantwerps_persoon)
/persoonscode_1=last(persoonscode_1)
/persoonscode_2=last(persoonscode_2)
/persoonscode_3=last(persoonscode_3)
/persoonscode_4=last(persoonscode_4)
...
*- een rij kan steeds slechts maximaal eigenaarswoning hebben, ongeacht of het over meerdere woningen en/of meerdere inwonende eigenaars gaat
